...
function IntroButtonItem(props) {
    ...
    const resumeLanguageMap = {
        default: '/src/assets/resumes/Resume-Jacob-Gomez-Hansen-English-Version.pdf',
        danish: '/src/assets/resumes/Resume-Jacob-Gomez-Hansen-Dansk-Version.pdf',
        norwegian: '/src/assets/resumes/Resume-Jacob-Gomez-Hansen-Norsk-Versjon.pdf',
    }

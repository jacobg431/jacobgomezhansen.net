...
function IntroButtonItem(props) {
    ...
    const resumeLanguageMap = {
        default: allResumes['/src/assets/resumes/Resume-Jacob-Gomez-Hansen-English-Version.pdf'],
        danish: allResumes['/src/assets/resumes/Resume-Jacob-Gomez-Hansen-Dansk-Version.pdf'],
        norwegian: allResumes['/src/assets/resumes/Resume-Jacob-Gomez-Hansen-Norsk-Versjon.pdf'],
    }
    ...
    return (
        <div className={buttonStyling} onClick={clickOptions[id]}>
            {text}
        </div>
    )
}

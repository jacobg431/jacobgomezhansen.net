...
function Introduction() {
    ...
    const iconStyling = 'cursor-pointer fill-red scale-400 hover:scale-600 duration-400 ease-out peer z-10'
    ...
    const iconContainerStyling = 'relative flex w-32 h-32 items-center justify-center z-5'
    ...
    const linkedInIcon = <FontAwesomeIcon 
        ...
        onMouseEnter={() => {return onIconMouseEnter("linkedin")}} 
        onMouseLeave={() => {return onIconMouseLeave("linkedin")}} 
    />

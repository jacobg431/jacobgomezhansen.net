...
export function whichTransitionEvent() {
    // SSR safety: no window/document → return empty string
    ...
    // Map of JS style property → transition end event name
    const transitions = {
    ...
    const match = Object.keys(transitions).find((prop) => el.style[prop] !== undefined)

    return match ? transitions[match] : ''
}

export const getRelativeBoundingBox = ({ childDomNode, parentDomNode, getPosition }) => {
 ...
 *
 */
export const getPositionDelta = ({ childDomNode, childBoundingBox, parentBoundingBox, getPosition }) => {
 ...
 * document flow.
 */
export const updateHeightPlaceholder = ({ domNode, parentData, getPosition }) => {
